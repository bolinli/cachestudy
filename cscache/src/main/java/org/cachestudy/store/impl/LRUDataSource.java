...
public class LRUDataSource<K,V> implements DataStore<K,V> {
    private static final Logger logger = LoggerFactory.getLogger(LRUDataSource.class);
    ...
    public LRUDataSource(int maxSize) {
